package concept.dateAndTime;

import concept.dateAndTime.newapi.FromAndWithMethodsDemo;
import concept.dateAndTime.newapi.GetPlusMinusMethodsDemo;
import concept.dateAndTime.newapi.OfMethodsDemo;
import concept.dateAndTime.newapi.ToAndAtMethodsDemo;
...
public class LatestDateTimeExample {
    ...
    public static void main(String[] args) {
        ...
        OfMethodsDemo.createCustmeDateTimeAndZone();

        LocalDate dateOfDays = OfMethodsDemo.getTheDateOfGiveYearAndDays(2024, 100);
        System.out.println(dateOfDays);

        // what will be date after epcho date that is 1970 after  1000 days
        LocalDate dateAfterDays = OfMethodsDemo.getDateAfterDays(1000);
        ...
        FromAndWithMethodsDemo.formAndWithExample();
        ToAndAtMethodsDemo.toAndAtMethodExample();

        GetPlusMinusMethodsDemo.getAndPlusMethodsExample();
