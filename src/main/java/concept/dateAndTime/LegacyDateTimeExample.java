...
import concept.dateAndTime.legacy.CalendarDemo;
import concept.dateAndTime.legacy.JavaSQLDate;
import concept.dateAndTime.legacy.JavaUtilDate;
...
public class LegacyDateTimeExample {
    ...
    private static void exampleOfGregorianCalendar() {
        CalendarDemo.gregorianCalendarExample();
    }

    private static void exampleOfJavaSqlDate() {
        JavaSQLDate.exampleOfJavaSqlDateCreation();
    }
